...
function ExpensesScreen() {
  ...
  const getBudgetInfo = async () => {
    try {
      ...
      getExpensesList(); // ✅ call after success
    } catch (err) {
      toast.error("Failed to fetch budget info");
      console.error("getBudgetInfo error:", err);
    }
  };
  ...
  const getExpensesList = async () => {
    try {
      const result = await db
        ...
        .where(
          and(
            eq(Expenses.budgetId, Number(budgetId)), // ✅ column on left, value on right
      ...
      console.error("getExpensesList error:", err);
    }
  };
